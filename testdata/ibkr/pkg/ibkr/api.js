 ...
 *   const result = await window.API.listV1APITickle();
 *
 * Environment:
...
// reportApiError broadcasts a failed API call as a "ibkr:ws-message"
...
function reportApiError(operationId, status, message) {
    window.dispatchEvent(new CustomEvent("ibkr:ws-message", {
        detail: {
            level: "error",
            persistent: true,
...
window.API = {
    // GET /v1/api/tickle
    listV1APITickle: () => apiFetch("/v1/api/tickle", {
        operationId: "ListV1APITickle",
    }),
};
