...
// Client is an HTTP client for the freepublicapis API.
type Client struct {
...
// GET /api/apis/{apiId}
func (c *Client) GetApiapiByApiidWithResult[R any](ctx context.Context, apiID int) (*R, error) {
	u := c.baseURL.JoinPath("api", "apis", strconv.Itoa(apiID))
	req := (&http.Request{
		Header: http.Header{
