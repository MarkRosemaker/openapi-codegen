...
const defaultUserAgent = "petapi/1.0"
...
// Client is an HTTP client for the petapi API.
type Client struct {
...
// GET /pets
func (c *Client) ListPetsWithResult[R any](ctx context.Context, params *ListPetsParams) (*R, error) {
	u := c.baseURL.JoinPath("pets")
	if params != nil {
		q := make(url.Values, 1)
